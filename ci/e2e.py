...
IMAGE='aaihb-restore-test:0.20.3'
...
def main():
    ...
    try:
        ...
        report['plugin_previous_zip_sha256']=hashlib.sha256((ROOT/'autorepair-ai-hosting-beta-0.20.2.zip').read_bytes()).hexdigest()
        report['plugin_zip_sha256']=hashlib.sha256((ROOT/'autorepair-ai-hosting-beta-0.20.3.zip').read_bytes()).hexdigest()
...
"""
        ...
        unzip_safe(ROOT/'autorepair-ai-hosting-beta-0.20.3.zip',site/'wp-content/plugins')
