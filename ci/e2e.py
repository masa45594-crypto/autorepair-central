...
def main():
    ...
    try:
        ...
        unzip_safe(ROOT/'autorepair-ai-hosting-beta-0.19.0.zip',site/'wp-content/plugins')
        report['plugin_previous_zip_sha256']=hashlib.sha256((ROOT/'autorepair-ai-hosting-beta-0.19.0.zip').read_bytes()).hexdigest()
        report['plugin_zip_sha256']=hashlib.sha256((ROOT/'autorepair-ai-hosting-beta-0.20.0.zip').read_bytes()).hexdigest()
