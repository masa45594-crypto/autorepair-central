...
try {
 ...
 $restored=strpos($source,"aaihb_rollback_fixture_loaded","v1")!==false && strpos($source,'aaihb_intentional_missing_function')===false;$history=isset($last['id'],$last['plugin'],$last['message']) && $last['plugin']===$plugin && strpos($last['message'],'戻しました')!==false;$database=get_option('aaihb_rollback_db_marker')==='before-update';
