...
try{
 ...
 $data=get_plugin_data(WP_PLUGIN_DIR.'/'.$plugin,false,false);$out['version_is_current']=($data['Version']??'')==='0.20.4';
 $out['legacy_data_preserved']=get_option('aaihb_upgrade_probe')==='legacy-0.20.3';
