...
final class AAIHB_Dashboard {
    ...
    public static function page() {
        ...
        echo '<div class="wrap aaihb-app aaihb-home" style="--blue:'.esc_attr($settings['accent']).'"><header class="aaihb-brand">'.($settings['hide_branding']?'':'<div><span class="aaihb-mark" aria-hidden="true">✦</span><strong>AutoRepair AI</strong><span class="aaihb-edition">HOSTING / 0.20.6</span></div>').'<span>'.esc_html($settings['company']?:'サイト運用ワークスペース').'</span></header>';
        self::nav('aaihb-home');
